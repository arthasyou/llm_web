...
pub struct LoraLinear {
    old: SharedTrc<FrozenLinear>,
    ff_a: Linear,
    ff_b: Linear,
    scale: Option<f64>,
    dropout: Option<SharedTrc<Dropout>>,
    merged: bool,
}
...
impl LoraLinear {
    pub fn new(
        ...
        Ok(LoraLinear {
            old: SharedTrc::new(FrozenLinear::new_from_linear(old)?),
            ...
            dropout: config.dropout.map(|x| SharedTrc::new(Dropout::new(x))),
            merged: false,
        })
    }
}
